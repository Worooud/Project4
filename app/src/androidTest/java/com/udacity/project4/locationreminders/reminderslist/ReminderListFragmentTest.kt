...
class ReminderListFragmentTest : AutoCloseKoinTest(){
    ...
    fun activeReminders_DisplayedInUi() = runBlocking {
        ...
        onView(ViewMatchers.withText(reminderDTO.description)).check(ViewAssertions.matches(
            ViewMatchers.isDisplayed()))
        onView(ViewMatchers.withText(reminderDTO.location)).check(ViewAssertions.matches(
            ViewMatchers.isDisplayed()))
    ...
    fun onRefreshLayoutSwipe_showToast() = runBlocking {
        ...
        onView(ViewMatchers.withText("Reminders refreshed"))
